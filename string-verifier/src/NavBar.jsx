...
<BrowserRouter>
        ...
        <MDBDropdown>
          <MDBDropdownToggle nav caret className="white-text">
            <span className="white-text mr-2"> جروباتي</span>
          </MDBDropdownToggle>
          <MDBDropdownMenu>
        ...
        <MDBCol md="6">
          <MDBInput hint=" مفضلتي مفضلتي" type="text" className="white-text text-right primary-color-dark pr-4" containerClass="active-primary-color-dark active-primary-color-dark-2 mt-0 mb-3" />
        </MDBCol>
        <MDBNavbarNav right>
          <MDBNavbarBrand>
            <MDBContainer>
